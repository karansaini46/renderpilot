export interface StylePreset {
  ...
  defaultGeometryLockMode: 'creative' | 'balanced' | 'accurate' | 'technical' | 'strict_structure' | 'balanced_enhancement' | 'creative_concept' | 'strict_geometry' | 'balanced_archviz' | 'high_realism';
  defaultSettings: {
    steps: number;
    cfg_scale: number;
    denoise: number;
...
export const STYLE_PRESETS: StylePreset[] = [
  {
    ...
    defaultGeometryLockMode: 'balanced_archviz',
    defaultSettings: { steps: 32, cfg_scale: 6.5, denoise: 0.38, edge_control_strength: 0.90, depth_control_strength: 0.75, upscale_factor: 1.5, upscale_denoise: 0.18 },
